...
public class ObjectMappingTest {
    ...
    public void shouldSerializePOJO() {
        ...
        @SuppressWarnings("unchecked") final Map<String, Object> packedProp = (Map<String, Object>) msgPackMap.get("packedProp");
        assertThat(packedProp).containsExactly(entry("foo", 123123L));

        @SuppressWarnings("unchecked") final Map<String, Object> objectProp = (Map<String, Object>) msgPackMap.get("objectProp");
